...
public class RepositoryScanner implements Iterable<String> {
	 ...
	 * 
	 * @param path
	 *            Le chemin de du répertoire objects à scanner
	 */
	...
	/**
	 * Scanne le dossier ciblé par la variable path et stocke les hashs obtenus
	 * dans la liste hashList
	 */
	private void scan() {
	...
	/**
	 * Scanne un dossier et ajoute les noms des fichiers trouvés à la liste
	 * hashList.
	 * 
	 * @param directory
