...
public class ObjectsViewController {
	...
	/**
	 * G�n�re l'arbre afficher dans l'onglet arbre, il pr�sente le contenu du
	 * commit contenant l'objet s�lectionn�.
	 * 
	 * @param object
	...
	/**
	 * Ajoute chaque TreeEntry d'un objet Tree � un TreeItem
	 * 
	 * @param tree
